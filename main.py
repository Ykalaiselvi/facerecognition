...
class Face_Recognition_System:
    def  __init__(self, root):
         ...
         img=Image.open(r"image/download (1).jpg")
         ...
         img1=Image.open(r"image/download 2.jpg")
         ...
         img2=Image.open(r"image/images 9.jpg")
         ...
         img3=Image.open(r"image/f.webp")
         ...
         title_lbl=Label(bg_img,text="FACE RECOGINTION ATTENDANCE SYSTEM SOFTWARE",font=("times new roman",35,"bold"),bg="white",fg="red")
         title_lbl.place(x=0,y=0,width=1530,height=45)
         
         #student button
         
         img4=Image.open(r"image/istockphoto-1463013729-612x612.jpg")
         ...
         img5=Image.open(r"image/images 7.jpg")
         ...
         img6=Image.open(r"image/download.jpg")
         ...
         img7=Image.open(r"image/help.jpg")
         ...
         img8=Image.open(r"image/train.jpg")
         ...
         img9=Image.open(r"image/images (2).jpg")
         ...
         img10=Image.open(r"image/download (2).jpg")
         ...
         img11=Image.open(r"image/images (1).jpg")
